...
echo -e "\n-> ceal.sh"
curl -O https://raw.github.com/ewancoder/dotfiles/master/.install/ceal.sh
echo -e "\n-> peal.sh"
curl -O https://raw.github.com/ewancoder/dotfiles/master/.install/peal.sh
echo -e "\n-> peal-user.sh"
curl -O https://raw.github.com/ewancoder/dotfiles/master/.install/peal-user.sh
echo -e "\n-> peal-merge.sh"
curl -O https://raw.github.com/ewancoder/dotfiles/master/.install/peal-merge.sh
